                    ...
                    <div class="bigslam-blog-title-content bigslam-item-pdlr">
                        <header class="bigslam-single-article-head clearfix">
                            ...
                            <div class="bigslam-single-article-head-right">
                                <h1 class="bigslam-single-article-title">{{$articled->titre}}</h1>
                                <div class="bigslam-blog-info-wrapper">
                                    <div class="bigslam-blog-info bigslam-blog-info-font bigslam-blog-info-category"><span class="bigslam-head"><i class="icon_folder-alt"></i></span>{{$articled->type}}</div>
                                    <div class="bigslam-blog-info bigslam-blog-info-font bigslam-blog-info-tag"><span class="bigslam-head"><i class="icon_tags_alt"></i></span><a href="#" rel="tag">{{$articled->created_at}}</a></div>
                                </div>
                            </div>
                        </header>
                    </div>
                            ...
                            <div class="bigslam-single-author">
                                <div class="bigslam-single-author-wrap">
                                    <div class="bigslam-single-author-content-wrap">
                                        <div class="bigslam-single-author-caption bigslam-info-font">Created by Ibet</div>
                                    </div>
                                </div>
                            </div>
