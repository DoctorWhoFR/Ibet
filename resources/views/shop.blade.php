...
<div class="bigslam-body-outer-wrapper ">
    <div class="bigslam-body-wrapper clearfix  bigslam-with-transparent-header bigslam-with-frame">
            ...
            <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                                ...
                                <rs-module id="rev_slider_1_1" style="display:none;" data-version="6.1.5">
                                    <rs-slides>
                                        <rs-slide data-key="rs-1" data-title="Slide" data-thumb="#" data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:d;">
                                            <img src="images/match-bf.jpg" title="slider-new-1" width="1920" height="1030" class="rev-slidebg" data-no-retina="">
                                            <!--
                -->
                ...
                -->
                                        ...
                                        <rs-slide data-key="rs-20" data-title="Slide" data-thumb="#" data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:d;">
                                            <img src="images/match-2.jpg" title="slider-new-2" width="1920" height="1030" class="rev-slidebg" data-no-retina="">
                                            <!--
                -->
        ...
        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container" style="padding-top: 20px;">
            <div class="gdlr-core-pbf-element">
                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                    <div class="gdlr-core-title-item-title-wrap ">
                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 40px; letter-spacing: 0px; text-transform: none;" data-orig-font="45px">Boutiques<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3></div>
                </div>
            </div>
            <div class="gdlr-core-pbf-element">
                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 50px ;">
                    <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;">
                        <p>Payement avec <strong>Paypal</strong>, 100% sécurisé !</p>
                    </div>
                </div>
            </div>
            <div class="gdlr-core-pbf-element">
                <div class="gdlr-core-price-table-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix  gdlr-core-style-1">
                    <div class="gdlr-core-price-table-column gdlr-core-column-20">
                        <h4>Un coupon de reduction ?</h4>
                        <form action="{{route('payment.coupons')}}" method="post">
                            {{csrf_field()}}
                            <label for=""><strong>Coupons: </strong><br>                             <input type="text" id="coupons" name="coupons">
                            </label>
                            <br>         <br>

                            @if(Session::has('coupons'))
                            <span><strong>Réduction actuelle:</strong> {{Session::get('coupons')}}%</span>
                                   <br>
                                <br>
                            @endif

                                <input type="submit"  value="Validé le coupon" class="gdlr-core-price-table-button gdlr-core-button">
                        </form>
                        <br>
                        <br>
                        <div class="gdlr-core-price-table ">
                            <div class="gdlr-core-price-table-head">
                                ...
                                <h3 class="gdlr-core-price-table-title">Pack Foot</h3>
                                <div class="gdlr-core-price-table-caption">Pack de base pour commencé</div>
                            </div>
                            <div class="gdlr-core-price-table-price gdlr-core-title-font"><span class="gdlr-core-price-prefix">€</span><span class="gdlr-core-price-table-price-number">5</span><span class="gdlr-core-price-suffix"></span></div>
                            <div class="gdlr-core-price-table-content-wrap gdlr-core-center-align">
                                ...
                                <div class="gdlr-core-price-table-content">
                                    <div class="gdlr-core-price-list-shortcode  gdlr-core-with-divider">
                                        <ul>
                                            <li><i class="fa fa-check"></i>+5 sûr Pronostique hebdomadaire !</li>
                                            <li><i class="fa fa-check"></i>Cote à 1.5 minimum !</li>
                                        </ul>
                                    </div>
                                </div>                                <form class="w3-container w3-display-middle w3-card-4 " method="POST" id="payment-form"  action="/payment/add-funds/paypal/pack">               {{ csrf_field() }}
                                    <button class="gdlr-core-price-table-button gdlr-core-button " href="javascript:void(0);"type="submit"><i class="fab fa-paypal"></i> Payé avec Paypal</button></form></div>
                    ...
                    <div class="gdlr-core-price-table-column gdlr-core-column-20">
                        <div class="gdlr-core-price-table gdlr-core-active">
                            <div class="gdlr-core-price-table-head">
                                <div class="gdlr-core-price-table-icon"><i class="fab fa-codepen"></i></div>
                                <h3 class="gdlr-core-price-table-title">Pack Foot + Bascket</h3>
                                <div class="gdlr-core-price-table-caption">Pour un investissement rentable à long terme.</div>
                            </div>
                            <div class="gdlr-core-price-table-price gdlr-core-title-font"><span class="gdlr-core-price-prefix">€</span><span class="gdlr-core-price-table-price-number">15</span><span class="gdlr-core-price-suffix">/ MO</span></div>
                            <div class="gdlr-core-price-table-content-wrap gdlr-core-center-align">
                                <div class="gdlr-core-price-table-content">
                                    <div class="gdlr-core-price-list-shortcode  gdlr-core-with-divider">
                                        <ul>
                                ...
                                </div>    <form class="w3-container w3-display-middle w3-card-4 " method="POST" id="payment-form"  action="/payment/add-funds/paypal/pack2">               {{ csrf_field() }}
                                    <button class="gdlr-core-price-table-button gdlr-core-button " href="javascript:void(0);"type="submit"><i class="fab fa-paypal"></i> Payé avec Paypal</button></form></div>
                        </div>
                    </div>
                    <div class="gdlr-core-price-table-column gdlr-core-column-20">
                        <div class="gdlr-core-price-table ">
                            <div class="gdlr-core-price-table-head">
                                <div class="gdlr-core-price-table-icon"><i class="fas fa-gem"></i></div>
                                <h3 class="gdlr-core-price-table-title"> Foot + Bascket + Tennis</h3>
                                <div class="gdlr-core-price-table-caption">Suitable for corporate</div>
                            </div>
                            <div class="gdlr-core-price-table-price gdlr-core-title-font"><span class="gdlr-core-price-prefix">€</span><span class="gdlr-core-price-table-price-number">25</span><span class="gdlr-core-price-suffix"></span></div>
                            <div class="gdlr-core-price-table-content-wrap gdlr-core-center-align">
                                <div class="gdlr-core-price-table-content">
                                    <div class="gdlr-core-price-list-shortcode  gdlr-core-with-divider">
                                        <ul>
                                ...
                                </div>    <form class="w3-container w3-display-middle w3-card-4 " method="POST" id="payment-form"  action="/payment/add-funds/paypal/pack3">               {{ csrf_field() }}
                                    <button class="gdlr-core-price-table-button gdlr-core-button " href="javascript:void(0);"type="submit"><i class="fab fa-paypal"></i> Payé avec Paypal</button></form></div>
                        </div>
                    </div>
                </div>
