...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/jq-3.3.1/dt-1.10.21/sc-2.0.2/datatables.min.css"/>
                                            ...
                                            <div class="gdlr-core-text-box-item-content" style="text-transform: none ;">
                                                <div class="sportspress sp-widget-align-none">
                                                    ...
                                                    <table  id="table_id" class="display">
                                                        ...
                                                        <tr>
                                                            @if($user->is_admin == 1)<td style="color:red;"> {{$user->email}}</td>@else<td>{{$user->email}}</td>@endif
                                                            <td>foot: {{$user->football}};<br> bascket: {{$user->basket}};<br> Tennis {{$user->tennis}}</td>
                                                            <td><a class="gdlr-core-button small" href="{{route('admins.user.upgrade', ['user'=> $user->id])}}">UPGRADE</a><a href="{{route('admins.user.makeadmin', ['user'=>$user->id])}}" class="gdlr-core-button small" style="background-color: black">ADMINS</a></td>
                                                        </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
                                                    <br>
                                                    <h4>Gestions des News</h4>
                                                    <form method="post" action="{{route('admins.news.store')}}">
                                                        {{csrf_field()}}
                                                        <label for=""> Titre:
                                                    ...
                                                    <br>
                                                    <br>
                                                    <table  id="table_idt" class="display">
                                                        <thead>
                                                        <tr style="font-size: 10px;">
                                                            <th>Id</th>
                                                        ...
                                                        <tbody>
                                                        @foreach(\App\Articles::all() as $user)
                                                            <tr>
                                                                <td>{{$user->id}}</td>
                                                                <td >{{$user->titre}}</td>
                                                                <td><a href="{{route('admins.news.delete', ['article'=>$user->id])}}">DELETE</a></td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
                                                             <br><br>
                                                    <h4>Gestions des Pronostiques</h4>
                                                    <form method="post" action="{{route('admins.pronostiques.store')}}">
                                                        {{csrf_field()}}
                                                        <label for=""> Equipe attaque:
                                                            <input type="text" id="equipe_attack" name="equipe_attack">
                                                        </label>
                                                        <br>
                                                        <br>
                                                        <label for=""> Equipe Defence:
                                                            <input type="text" id="equipe_defence" name="equipe_defence">
                                                        </label>
                                                        <br>
                                                        <br>
                                                        <label for=""> Pronostique:
                                                            <input type="text" id="pronostique" name="pronostique">
                                                        </label>
                                                        <br>
                                                        <br>
                                                        <label for=""> Cote moyen:
                                                            <input type="text" id="cote_moyen" name="cote_moyen">
                                                        </label>
                                                        <br>
                                                        <br>
                                                        <label for=""> Confiance (en %):
                                                            <input type="number" id="confiance" name="confiance">
                                                        </label>
                                                        <br>
                                                        <br>
                                                        <label for=""> Type:
                                                            <select name="type" id="type">
                                                                <option value="">--Merci de choisir un type--</option>
                                                                <option value="foot">Foot</option>
                                                                <option value="tennis">Tennis</option>
                                                                <option value="bascket">Bascket</option>
                                                            </select>                                                        </label>
                                                        <br>
                                                        <br>
                                                        <label for=""> Date:
                                                    ...
                                                    <table  id="pronostique_table" class="display">
                                                        <thead>
                                                        <tr style="font-size: 10px;">
                                                            <th>Id</th>
                                                            <th style="width: 50px;">titre</th>
                                                        ...
                                                        <tbody>
                                                        @foreach(\App\Pronostiques::all() as $user)
                                                            <tr>
                                                                <td>{{$user->id}}</td>
                                                                <td >{{$user->equipe_attack}} Vs {{$user->equipe_defence}}</td>
                                                                <td><form>{{csrf_field()}}<a href="{{route('admins.pronostiques.destroy', ['pronostique'=>$user->id])}}" CLASS="gdlr-core-button gdlr-core-small" style="background-color: yellow;color:black;">DELETE</a></form><a href="{{route('admins.pronostiques.status', ['pronostique'=>$user->id, 'status'=>'finished'])}}" CLASS="gdlr-core-button gdlr-core-small" style="background-color: #0f9d58">GAGNER</a><a href="{{route('admins.pronostiques.status', ['pronostique'=>$user->id, 'status'=>'lost'])}}" CLASS="gdlr-core-button gdlr-core-small">PERDU</a></td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <br><br>
                                                    <h4>Gestions des Combines</h4>
                                                    <form method="post" action="{{route('admins.combines')}}" >
                                                        {{csrf_field()}}
                                                        <label for="">
                                                            Titre:
                                                        </label>
                                                        ...
                                                        <textarea name="analyse" id="" cols="30" rows="10" id="analyse"></textarea>
                                                        <label for="">Pronostique:</label>
                                                        <select name="defaultpronostique" id="defaultpronostique">
                                                            @foreach(\App\Pronostiques::where('status', '!=', 'finished')->get() as $pronostique)
                                                                <option value="{{$pronostique->id}}">{{$pronostique->type}} | {{$pronostique->equipe_defence}} VS {{$pronostique->equipe_attack}}</option>
                                                            @endforeach
                                                        </select>
                                                        <div id="conbinesforms">

                                                        </div>
                                                        <a onclick="addForms();" href="javascript:void(0)" class="gdlr-core-button gdlr-core-round-button ">Ajouter un pronostique</a>
                                                        <input type="submit" class="btn btn-block">
                                                    </form>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <table  id="combines_table" class="display">
                                                        <thead>
                                                        <tr style="font-size: 10px;">
                                                            <th>Id</th>
                                                            <th style="width: 50px;">titre</th>
                                                        ...
                                                        <tbody>
                                                        @foreach(\App\Conbines::all() as $user)
                                                            <tr>
                                                                <td>{{$user->id}}</td>
                                                                <td >{{$user->titre}}</td>
                                                                <td><form>{{csrf_field()}}<a href="{{route('admins.pronostiques.destroy', ['pronostique'=>$user->id])}}" CLASS="gdlr-core-button gdlr-core-small" style="background-color: yellow;color:black;">DELETE</a></form><a href="{{route('admins.pronostiques.status', ['pronostique'=>$user->id, 'status'=>'finished'])}}" CLASS="gdlr-core-button gdlr-core-small" style="background-color: #0f9d58">GAGNER</a><a href="{{route('admins.pronostiques.status', ['pronostique'=>$user->id, 'status'=>'lost'])}}" CLASS="gdlr-core-button gdlr-core-small">PERDU</a></td>
...
<script type='text/javascript' >
    ...
    function addForms(){
        ...
        text.innerHTML = "Pronostique " + counter;
        node.name = "pronostique."+counter
        counter++;
        document.getElementById("conbinesforms").appendChild(text);
        document.getElementById("conbinesforms").appendChild(node);

        @foreach(\App\Pronostiques::where('status', '!=', 'finished')->get() as $pronostique)
            var option = document.createElement("option");
            option.text = "{{strtoupper($pronostique->type)}} | {{$pronostique->equipe_attack}} VS {{$pronostique->equipe_defence}}";
            option.value = "{{$pronostique->id}}";
            node.add(option);
        @endforeach
    }
</script>
...
<script>
    ...
    $(document).ready( function () {
        $('#pronostique_table').DataTable();
    } );
    $(document).ready( function () {
        $('#combines_table').DataTable();
    } );
