            ...
            <div class="gdlr-core-page-builder-body">
                ...
                <div class="gdlr-core-pbf-wrapper " data-skin="Hp1 Score">
                    <div class="gdlr-core-pbf-background-wrap">
                        <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(images/match-2.jpg) ;background-size: cover ;background-position: center ;" data-parallax-speed="0.1"></div>
                    </div>
                                ...
                                <div class="gdlr-core-sp-featured-event-item gdlr-core-item-pdb clearfix ">
                                    <div class="bigslam-sp-event-featured-top bigslam-status-score">
                                        <div class="bigslam-sp-event-featured-title bigslam-title-font clearfix">
                                            <h1 class="gdlr-core-center-align">Victoire !</h1>
                                            <div class="bigslam-sp-event-featured-title-left"><span class="bigslam-sp-team-logo"><img width="90" height="80" src="images/shield.png" class="attachment-sportspress-fit-medium size-sportspress-fit-medium wp-post-image" alt=""  sizes="(max-width: 90px) 100vw, 90px"></span><span class="bigslam-sp-team-name" style="font-weight: 400  !important;letter-spacing: 0px  !important;text-transform: none  !important;margin-top: 30px  !important;">{{\App\Pronostiques::where('status', 'finished')->get()->last()->equipe_defence}}</span></div><span class="bigslam-sp-event-result" style="margin-top: 0px  !important;"><a class="gdlr-core-skin-title-important" href="#">0<span class="bigslam-sp-event-result-sep"> - </span>5</a>
                                                </span>
                                            <div class="bigslam-sp-event-featured-title-right"><span class="bigslam-sp-team-logo"><img width="110" height="119" src="images/sport.png" class="attachment-sportspress-fit-medium size-sportspress-fit-medium wp-post-image" alt="" ></span><span class="bigslam-sp-team-name" style="font-weight: 400  !important;letter-spacing: 0px  !important;text-transform: none  !important;margin-top: 30px  !important;">{{\App\Pronostiques::where('status', 'finished')->get()->last()->equipe_attack}}</span></div>
                                        </div>
                                        <div class="bigslam-sp-event-featured-info"><span class="bigslam-sp-event-date">{{\App\Pronostiques::where('status', 'finished')->get()->last()->date_fin}}</span></div>
                                        <div class="bigslam-sp-event-featured-link"><a class="gdlr-core-button gdlr-core-rectangle   gdlr-core-button-with-border" href="#" style="border-radius: 30px;-moz-border-radius: 30px;-webkit-border-radius: 30px;"><strong>Cote:</strong> {{\App\Pronostiques::where('status', 'finished')->get()->last()->cote_moyen}}</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="gdlr-core-pbf-column gdlr-core-column-40 gdlr-core-column-first">
                                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                                        ...
                                                        <div class="sp-template sp-template-event-list">
                                                            <div class="bigslam-sp-event-featured-holder clearfix">
                                                                ...
                                                                <div class="bigslam-sp-event-featured-list clearfix" style="margin-bottom: 15px">
                                                                    <h4 class="gdlr-core-center-align">Foot</h4>

                                                                    <div class="bigslam-sp-event-featured-title bigslam-title-font"><span class="bigslam-sp-team-logo"><img width="110" height="119" src="upload/flag-4.png" class="attachment-sportspress-fit-medium size-sportspress-fit-medium wp-post-image" alt="" ></span><span class="bigslam-sp-team-name">{{$foot->equipe_defence}}</span><span class="bigslam-sp-event-result"><a href="#">VS</a></span><span class="bigslam-sp-team-name" style="font-size: 10px;">{{$foot->equipe_attack}}</span><span class="bigslam-sp-team-logo"><img width="90" height="89" src="upload/flag-15.png" class="attachment-sportspress-fit-medium size-sportspress-fit-medium wp-post-image" alt="" ></span></div>
                                                                    <div class="bigslam-sp-event-featured-info"><span class="bigslam-sp-event-date">{{$foot->date_debut}}</span><span class="bigslam-sp-event-venue"><a href="#" rel="tag">       @if(Auth::user() != null && Auth::user()->football == 1 && Auth::user()->basket == 1 && Auth::user()->tennis == 1)
                                                                ...
                                                                <div class="bigslam-sp-event-featured-list clearfix" style="margin-bottom: 15px">
                                                                    <h4 class="gdlr-core-center-align">Bascket</h4>
                                                                ...
                                                                <div class="bigslam-sp-event-featured-list clearfix" style="margin-bottom: 15px">
                                                                    <h4 class="gdlr-core-center-align">Tennis</h4>

                                                                    <div class="bigslam-sp-event-featured-title bigslam-title-font"><span class="bigslam-sp-team-logo"><img width="110" height="119" src="upload/flag-4.png" class="attachment-sportspress-fit-medium size-sportspress-fit-medium wp-post-image" alt="" ></span><span class="bigslam-sp-team-name">{{$tennis->equipe_defence}}</span><span class="bigslam-sp-event-result"><a href="#">VS</a></span><span class="bigslam-sp-team-name" style="font-size: 10px;">{{$tennis->equipe_attack}}</span><span class="bigslam-sp-team-logo"><img width="90" height="89" src="upload/flag-15.png" class="attachment-sportspress-fit-medium size-sportspress-fit-medium wp-post-image" alt="" ></span></div>
                                        ...
                                        <div class="gdlr-core-pbf-element">
                                            <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align" style="margin-top: -37px ;"><a class="gdlr-core-button  gdlr-core-button-gradient gdlr-core-button-no-border gdlr-core-button-full-width" href="{{route('pronostiques')}}" style="font-size: 15px ;font-weight: 500 ;letter-spacing: 0px ;color: #ffffff ;text-transform: none ;border-radius: 0px;-moz-border-radius: 0px;-webkit-border-radius: 0px;background: #000000 ;"><span class="gdlr-core-content">Pronostiques</span></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="gdlr-core-pbf-wrapper " style="padding: 100px 0px 70px 0px;">
                    <div class="gdlr-core-pbf-background-wrap"></div>
                    <div class="gdlr-core-pbf-background-wrap" style="bottom: 19px ;">
                        <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/bg-blog.jpg) ;background-size: cover ;background-position: center ;" data-parallax-speed="0"></div>
                    </div>
                    <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                            <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first">
                                    ...
                                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                        <div class="gdlr-core-pbf-element">
                                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 60px ;">
                                                <div class="gdlr-core-title-item-title-wrap ">
                                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 28px ;font-weight: 600 ;letter-spacing: 0px ;line-height: 1 ;text-transform: none ;"><span class="gdlr-core-title-item-left-divider" style="border-color: #f27052 ;border-left-width: 5px ;margin-right: 19px ;"></span>Dernières articles<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first">
                                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                        <div class="gdlr-core-pbf-element">
                                            <div class="gdlr-core-blog-item gdlr-core-item-pdb clearfix  gdlr-core-style-blog-column-with-frame" id="gdlr-core-blog-30337">
                                                <div class="gdlr-core-blog-item-holder gdlr-core-js-2 clearfix" data-layout="fitrows">
                                                    @foreach(array_reverse($last_articles->toArray()) as $article)
                                                        <div class="gdlr-core-item-list  gdlr-core-item-pdlr gdlr-core-column-20 gdlr-core-column-first">
                                                            <div class="gdlr-core-blog-grid gdlr-core-style-4 gdlr-core-js  gdlr-core-blog-grid-with-frame gdlr-core-item-mgb gdlr-core-skin-e-background  gdlr-core-outer-frame-element gdlr-core-with-thumbnail gdlr-core-move-up-with-shadow gdlr-core-outer-frame-element" style="box-shadow: 0px 20px 35px rgba(36, 38, 53,0.09); -moz-box-shadow: 0px 20px 35px rgba(36, 38, 53,0.09); -webkit-box-shadow: 0px 20px 35px rgba(36, 38, 53,0.09); border-width: 0px;border-color: #ffffff ;border-radius: 7px;-moz-border-radius: 7px;-webkit-border-radius: 7px;" data-sync-height="blog-item-1">

                                                                <div class="gdlr-core-blog-grid-frame gdlr-core-sync-height-space-position clearfix">
                                                                    <div class="gdlr-core-blog-grid-top-info clearfix"><span class="gdlr-core-blog-info gdlr-core-blog-info-font gdlr-core-skin-caption gdlr-core-blog-info-date"><span class="gdlr-core-head"><i class="fa fa-clock-o"></i></span><a href="#">{{$article['created_at']}}</a></span><span class="gdlr-core-blog-info gdlr-core-blog-info-font gdlr-core-skin-caption gdlr-core-blog-info-tag"><span class="gdlr-core-head"><i class="icon_tags_alt"></i></span><a href="#" rel="tag">{{$article['type']}}</a></span>
                                                                    </div>
                                                                    <h3 class="gdlr-core-blog-title gdlr-core-skin-title" style="font-size: 20px ;font-weight: 500 ;letter-spacing: 0px ;"><a href="{{route('news.show', ['article'=>$article['id']])}}">{{$article['titre']}}</a></h3>
                                                                    <div class="gdlr-core-blog-content">{{substr($article['contenu'], 1, 60)}}...
                                                                        <div class="clear"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="gdlr-core-pbf-element">
                                            <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align" style="padding-bottom: 0px ;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
